...
need to define a subclass of [`Component`](https://api.emberjs.com/ember/3.8/classes/Component). For example, you would
...
The [`{{component}}`](https://api.emberjs.com/ember/3.8/classes/Ember.Templates.helpers/methods/component?anchor=component) helper can be used to defer the selection of a component to
...
The real value of [`{{component}}`](https://api.emberjs.com/ember/3.8/classes/Ember.Templates.helpers/methods/component?anchor=component) comes from being able to dynamically pick
