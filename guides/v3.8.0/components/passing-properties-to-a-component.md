...
set the [`positionalParams`](https://api.emberjs.com/ember/3.8/classes/Component/properties/positionalParams?anchor=positionalParams) attribute in your component class.
