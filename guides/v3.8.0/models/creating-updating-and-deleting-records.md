...
the [`destroyRecord`](https://api.emberjs.com/ember-data/3.8/classes/DS.Model/methods/deleteRecord?anchor=destroyRecord) method to delete and persist at the same time.
