...
- [DS.Adapter](https://api.emberjs.com/ember-data/3.8/classes/DS.Adapter) is the basic adapter
...
- [DS.JSONAPIAdapter](https://api.emberjs.com/ember-data/3.8/classes/DS.JSONAPIAdapter)
...
- [DS.RESTAdapter](https://api.emberjs.com/ember-data/3.8/classes/DS.RESTAdapter)
