...
[`JSONAPISerializer`](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPISerializer)
is the default serializer and works with JSON:API backends. The
[`JSONSerializer`](https://api.emberjs.com/ember-data/release/classes/DS.JSONSerializer)
is a simple serializer for working with single JSON object or arrays of records. The
[`RESTSerializer`](https://api.emberjs.com/ember-data/release/classes/DS.RESTSerializer)
...
the [`serialize()`](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPISerializer/methods/serialize?anchor=serialize)
...
you can use the
[`normalizeResponse()`](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPISerializer/methods/serialize?anchor=normalizeResponse)
...
[`normalize()`](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPISerializer/methods/serialize?anchor=normalize)
hook similarly.

For more hooks to customize the serializer with, see the [Ember Data serializer
API documentation](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPISerializer).
...
[`keyForAttribute()`](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPISerializer/methods/keyForAttribute?anchor=keyForAttribute)
...
the
[`keyForRelationship()`](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPISerializer/methods/keyForAttribute?anchor=keyForRelationship)
method.
...
[API docs](https://api.emberjs.com/ember-data/release/classes/DS.JSONSerializer)
...
[normalizeResponse](https://api.emberjs.com/ember-data/release/classes/DS.Serializer/methods/normalizeResponse?anchor=normalizeResponse)
...
[serialize](https://api.emberjs.com/ember-data/release/classes/DS.Serializer/methods/serialize?anchor=serialize)
method.
