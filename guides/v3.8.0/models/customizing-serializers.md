...
you can use the
[`normalizeResponse()`](https://api.emberjs.com/ember-data/3.8/classes/DS.JSONAPISerializer/methods/serialize?anchor=normalizeResponse)
...
[`normalize()`](https://api.emberjs.com/ember-data/3.8/classes/DS.JSONAPISerializer/methods/serialize?anchor=normalize)
hook similarly.
...
the
[`keyForRelationship()`](https://api.emberjs.com/ember-data/3.8/classes/DS.JSONAPISerializer/methods/keyForAttribute?anchor=keyForRelationship)
method.
