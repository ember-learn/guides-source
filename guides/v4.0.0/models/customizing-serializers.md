...
[`JSONAPISerializer`](https://api.emberjs.com/ember-data/4.0.0/classes/JSONAPISerializer)
is the default serializer and works with JSON:API backends. The
[`JSONSerializer`](https://api.emberjs.com/ember-data/4.0.0/classes/JSONSerializer)
is a simple serializer for working with single JSON object or arrays of records. The
[`RESTSerializer`](https://api.emberjs.com/ember-data/4.0.0/classes/RESTSerializer)
...
the [`serialize()`](https://api.emberjs.com/ember-data/4.0.0/classes/JSONAPISerializer/methods/serialize?anchor=serialize)
...
you can use the
[`normalizeResponse()`](https://api.emberjs.com/ember-data/4.0.0/classes/JSONAPISerializer/methods/normalizeResponse?anchor=normalizeResponse)
...
[`normalize()`](https://api.emberjs.com/ember-data/4.0.0/classes/JSONAPISerializer/methods/normalize?anchor=normalize)
hook similarly.

For more hooks to customize the serializer with, see the [Ember Data serializer
API documentation](https://api.emberjs.com/ember-data/4.0.0/classes/JSONAPISerializer).
...
[`keyForAttribute()`](https://api.emberjs.com/ember-data/4.0.0/classes/JSONAPISerializer/methods/keyForAttribute?anchor=keyForAttribute)
...
the
[`keyForRelationship()`](https://api.emberjs.com/ember-data/4.0.0/classes/JSONAPISerializer/methods/keyForRelationship?anchor=keyForRelationship)
method.
...
[API docs](https://api.emberjs.com/ember-data/4.0.0/classes/JSONSerializer)
...
[normalizeResponse](https://api.emberjs.com/ember-data/4.0.0/classes/Serializer/methods/normalizeResponse?anchor=normalizeResponse)
...
[normalize](https://api.emberjs.com/ember-data/4.0.0/classes/Serializer/methods/normalize?anchor=normalize)
method.
...
[serialize](https://api.emberjs.com/ember-data/4.0.0/classes/Serializer/methods/serialize?anchor=serialize)
method.
