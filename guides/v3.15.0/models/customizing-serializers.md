...
[`normalize()`](https://api.emberjs.com/ember-data/3.15/classes/JSONAPISerializer/methods/normalize?anchor=normalize)
hook similarly.
...
the
[`keyForRelationship()`](https://api.emberjs.com/ember-data/3.15/classes/JSONAPISerializer/methods/keyForRelationship?anchor=keyForRelationship)
method.
...
[normalizeResponse](https://api.emberjs.com/ember-data/3.15/classes/Serializer/methods/normalizeResponse?anchor=normalizeResponse)
