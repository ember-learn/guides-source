...
[`save()`](https://api.emberjs.com/ember-data/3.15/classes/Model/methods/save?anchor=save) returns
...
Deleting records is as straightforward as creating records. Call [`deleteRecord()`](https://api.emberjs.com/ember-data/3.15/classes/Model/methods/deleteRecord?anchor=deleteRecord)
...
the [`destroyRecord`](https://api.emberjs.com/ember-data/3.15/classes/Model/methods/destroyRecord?anchor=destroyRecord) method to delete and persist at the same time.
