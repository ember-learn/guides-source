...
A small number of commonly-used invokables are always available, without needing to import them. This includes [on](https://api.emberjs.com/ember/7.2.0/functions/Keywords/on) for event handling, boolean logic helpers like [and](https://api.emberjs.com/ember/7.2.0/functions/Keywords/and), comparisons like [eq](https://api.emberjs.com/ember/7.2.0/functions/Keywords/eq), and others. See the full list on the [Ember Helpers API Docs](https://api.emberjs.com/ember/7.2.0/modules/@ember%2Fhelper).
