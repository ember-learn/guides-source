...
For the full list of available helpers, you can check the [Ember Helper](https://api.emberjs.com/ember/7.2.0/modules/@ember%2Fhelper) documentation.

### The `get` helper

The [`{{get}}`](https://api.emberjs.com/ember/7.2.0/classes/@ember%2Fhelper/methods/get?anchor=get)
...
[`{{concat}}`](https://api.emberjs.com/ember/7.2.0/classes/@ember%2Fhelper/methods/concat?anchor=concat)
...
block helper.
The [`{{let}}`](https://api.emberjs.com/ember/7.2.0/classes/Ember.Templates.helpers/methods/let?anchor=let)
...
List](https://api.emberjs.com/ember/7.2.0/modules/@ember%2Fhelper) is always
available without an explicit import.

### The `array` helper

Using the [`{{array}}`](https://api.emberjs.com/ember/7.2.0/classes/@ember%2Fhelper/methods/concat?anchor=array) helper,
...
Using the [`{{hash}}`](https://api.emberjs.com/ember/7.2.0/classes/@ember%2Fhelper/methods/hash?anchor=hash)
...
Using the [`{{in-element}}`](https://api.emberjs.com/ember/7.2.0/classes/Ember.Templates.helpers/methods/in-element?anchor=in-element) helper, you can render content into a DOM element that is in a _different_ part of the page.
