...
Use [Package Control](https://packagecontrol.io) to install 2 packages: [Template Tag](https://github.com/ijlee2/sublime-syntax-definition-template-tag) and Handlebars.
