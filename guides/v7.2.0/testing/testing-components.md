...
Imagine you have a typeahead component that uses [`debounce`](https://api.emberjs.com/ember/7.2.0/functions/@ember%2Frunloop/debounce) to limit requests to the server, and you want to verify that results are displayed after typing a character.
