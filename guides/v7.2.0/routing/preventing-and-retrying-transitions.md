...
or a URL change, a `routeWillChange` event is fired on the [`RouterService`](https://api.emberjs.com/ember/7.2.0/classes/RouterService/events). This gives each active route, starting with the leaf-most
