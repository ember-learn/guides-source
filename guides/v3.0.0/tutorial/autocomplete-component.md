...
A [promise](https://api.emberjs.com/ember/3.0/classes/Promise) is a JavaScript object that represents the result of an asynchronous function.
...
such as [limiting the number of requests made to the server](https://api.emberjs.com/ember/3.0/classes/@ember%2Frunloop/methods/debounce?anchor=debounce).
...
Since our component is expecting the filter process to be asynchronous, we return promises from our filter, using [Ember's RSVP library](https://api.emberjs.com/ember/3.0/modules/rsvp).
