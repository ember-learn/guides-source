...
you must look up the service using Ember's [`getOwner`](https://api.emberjs.com/ember/3.0/classes/@ember%2Fapplication/methods/getOwner?anchor=getOwner) instead.
