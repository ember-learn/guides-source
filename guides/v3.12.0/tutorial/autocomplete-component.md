...
A [promise](https://api.emberjs.com/ember/3.12/classes/Promise) is a JavaScript object that represents the result of an asynchronous function.
...
such as [limiting the number of requests made to the server](https://api.emberjs.com/ember/3.12/classes/@ember%2Frunloop/methods/debounce?anchor=debounce).
