...
To instantiate the service, we can instantiate it through ember's resolver using the [`factoryFor`](https://api.emberjs.com/ember/3.12/classes/ApplicationInstance/methods/factoryFor?anchor=factoryFor) method.
