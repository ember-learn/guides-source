...
The [`map()`](https://api.emberjs.com/ember/3.12/classes/EmberRouter/methods/map?anchor=map) method
...
for [the router](https://api.emberjs.com/ember/3.12/classes/EmberRouter) and for [route
handlers](https://api.emberjs.com/ember/3.12/classes/Route).
...
- From a route, use the [`transitionTo()`](https://api.emberjs.com/ember/3.12/classes/Route/methods/transitionTo?anchor=transitionTo) method
- From a controller, use the [`transitionToRoute()`](https://api.emberjs.com/ember/3.12/classes/Controller/methods/transitionToRoute?anchor=transitionToRoute) method
- From anywhere else in your application, such as a component, inject the [Router Service](https://api.emberjs.com/ember/3.12/classes/RouterService) and use the [`transitionTo()`](https://api.emberjs.com/ember/3.12/classes/RouterService/methods/transitionTo?anchor=transitionTo) method
