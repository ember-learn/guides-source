...
should export a subclass of [`Ember.Helper`](https://api.emberjs.com/ember/3.12/classes/Helper).
Helper classes must contain a
[`compute`](https://api.emberjs.com/ember/3.12/classes/Helper/methods/compute?anchor=compute) method that behaves the same as the function passed to
...
[`htmlSafe`](https://api.emberjs.com/ember/3.12/functions/@ember%2Ftemplate/htmlSafe) string utility:
...
[`htmlSafe`](https://api.emberjs.com/ember/3.12/functions/@ember%2Ftemplate/htmlSafe)),
