...
- [DS.Adapter](https://api.emberjs.com/ember-data/3.12/classes/Adapter) is the basic adapter
...
- [DS.JSONAPIAdapter](https://api.emberjs.com/ember-data/3.12/classes/JSONAPIAdapter)
...
- [DS.RESTAdapter](https://api.emberjs.com/ember-data/3.12/classes/RESTAdapter)
