...
- [`Adapter`](https://api.emberjs.com/ember-data/3.20/classes/Adapter) is the basic adapter
...
- [`JSONAPIAdapter`](https://api.emberjs.com/ember-data/3.20/classes/JSONAPIAdapter)
...
- [`RESTAdapter`](https://api.emberjs.com/ember-data/3.20/classes/RESTAdapter)
