...
* [`<Input />`](https://api.emberjs.com/ember/3.20/classes/Ember.Templates.components/methods/Input?anchor=Input)
* [`<Textarea />`](https://api.emberjs.com/ember/3.20/classes/Ember.Templates.components/methods/Textarea?anchor=Textarea)
...
Checkboxes are a special input type.  If you want to dispatch an action on a certain [event](https://api.emberjs.com/ember/3.20/classes/Component#event-handler-methods),
...
[`<Textarea>`](https://api.emberjs.com/ember/3.20/classes/Ember.Templates.components/methods/Textarea?anchor=Textarea) supports binding and/or setting the following properties:
