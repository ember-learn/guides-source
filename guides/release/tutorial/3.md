...
Fortunately, our designer sent us some CSS for us to use, so we can just go ahead and copy this into the `app/styles/app.css` file. This file has all the styles we need for building the rest of the app.
