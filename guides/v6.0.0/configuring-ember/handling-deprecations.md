...
You can use the [deprecation handlers](https://api.emberjs.com/ember/6.0.0/functions/@ember%2Fdebug/registerDeprecationHandler) API to check for what release a deprecated feature will be removed.
