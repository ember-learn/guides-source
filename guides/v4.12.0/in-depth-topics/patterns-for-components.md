...
The [`{{component}}`](https://api.emberjs.com/ember/4.12.0/classes/Ember.Templates.helpers/methods/component?anchor=component)
...
The real value of [`{{component}}`](https://api.emberjs.com/ember/4.12.0/classes/Ember.Templates.helpers/methods/component?anchor=component)
