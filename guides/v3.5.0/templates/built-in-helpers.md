...
The [`{{get}}`](https://api.emberjs.com/ember/3.5/classes/Ember.Templates.helpers/methods/get?anchor=get) helper
...
For example, the [`{{concat}}`](https://api.emberjs.com/ember/3.5/classes/Ember.Templates.helpers/methods/concat?anchor=concat)
...
The [`{{let}}`](https://api.emberjs.com/ember/3.5/classes/Ember.Templates.helpers/methods/let?anchor=let) helper lets you create new bindings in your template.
