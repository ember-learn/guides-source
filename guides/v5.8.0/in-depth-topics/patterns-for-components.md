...
The [`{{component}}`](https://api.emberjs.com/ember/5.8.0/classes/Ember.Templates.helpers/methods/component?anchor=component)
...
The real value of [`{{component}}`](https://api.emberjs.com/ember/5.8.0/classes/Ember.Templates.helpers/methods/component?anchor=component)
