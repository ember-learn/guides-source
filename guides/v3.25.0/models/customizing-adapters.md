...
- [`Adapter`](https://api.emberjs.com/ember-data/3.25.0/classes/Adapter) is the basic adapter
...
- [`JSONAPIAdapter`](https://api.emberjs.com/ember-data/3.25.0/classes/JSONAPIAdapter)
...
- [`RESTAdapter`](https://api.emberjs.com/ember-data/3.25.0/classes/RESTAdapter)
