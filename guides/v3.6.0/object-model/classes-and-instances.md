...
To define a new Ember _class_, call the [`extend()`](https://api.emberjs.com/ember/3.6/classes/@ember%2Fobject/methods/extend?anchor=extend) method on
[`EmberObject`](https://api.emberjs.com/ember/3.6/modules/@ember%2Fobject):
...
of Ember's built-in [`Component`](https://api.emberjs.com/ember/3.6/classes/Component) class:
...
One common example is when overriding the [`normalizeResponse()`](https://api.emberjs.com/ember-data/3.6/classes/DS.JSONAPISerializer/methods/normalizeResponse?anchor=normalizeResponse) hook in one of Ember-Data's serializers.
...
class by calling its [`create()`](https://api.emberjs.com/ember/3.6/classes/@ember%2Fobject/methods/create?anchor=create
...
When a new instance is created, its [`init()`](https://api.emberjs.com/ember/3.6/classes/EmberObject/methods/init?anchor=init) method is invoked
...
[Ember proxy objects](https://api.emberjs.com/ember/3.6/classes/ObjectProxy) are the one big exception to this rule. If you're working with Ember proxy objects, including promise proxies for async relationships in Ember Data, you have to use Ember's [`get()`](https://api.emberjs.com/ember/3.6/classes/@ember%2Fobject/methods/get?anchor=get) accessor method to read values.
