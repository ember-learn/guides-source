...
To load a model for the `favorite-posts` route, you would use the [`model()`](https://api.emberjs.com/ember/3.6/classes/Route/methods/model?anchor=model)
...
[RSVP.hash](https://api.emberjs.com/ember/3.6/classes/rsvp/methods/hash?anchor=hash).
