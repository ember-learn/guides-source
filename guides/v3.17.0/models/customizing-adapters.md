...
- [`Adapter`](https://api.emberjs.com/ember-data/3.17/classes/Adapter) is the basic adapter
...
- [`JSONAPIAdapter`](https://api.emberjs.com/ember-data/3.17/classes/JSONAPIAdapter)
...
- [`RESTAdapter`](https://api.emberjs.com/ember-data/3.17/classes/RESTAdapter)
