...
Please see the [API documentation of the `if` helper](https://api.emberjs.com/ember/5.3.0/classes/Ember.Templates.helpers/methods/if?anchor=if) for more patterns.
