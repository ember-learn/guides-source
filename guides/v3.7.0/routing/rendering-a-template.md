...
If you want to render a template other than the default one, set the route's [`templateName`](https://api.emberjs.com/ember/3.7/classes/Route/properties/templateName?anchor=templateName) property to the name of
...
You can override the [`renderTemplate()`](https://api.emberjs.com/ember/3.7/classes/Route/methods/renderTemplate?anchor=renderTemplate) hook if you want finer control over template rendering.
