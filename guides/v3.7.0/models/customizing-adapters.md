...
- [DS.Adapter](https://api.emberjs.com/ember-data/release/classes/DS.Adapter) is the basic adapter
...
- [DS.JSONAPIAdapter](https://api.emberjs.com/ember-data/release/classes/DS.JSONAPIAdapter)
...
- [DS.RESTAdapter](https://api.emberjs.com/ember-data/release/classes/DS.RESTAdapter)
...
[volatile](https://api.emberjs.com/ember/release/classes/@ember%2Fobject%2Fcomputed/methods/property?anchor=volatile)
