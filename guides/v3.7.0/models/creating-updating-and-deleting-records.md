...
The `backgroundReload` option is used to prevent the fetching of the destroyed record, since [`findRecord()`](<https://api.emberjs.com/ember-data/release/classes/DS.Store/methods/findRecord?anchor=findRecord>
