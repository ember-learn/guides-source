A [`Service`](https://api.emberjs.com/ember/6.5.0/classes/Service) is an Ember object that lives for the duration of the application, and can be made available in different parts of your application.
...
Services must extend the [`Service`](https://api.emberjs.com/ember/6.5.0/classes/Service) base class:
...
you must look up the service using Ember's [`getOwner`](https://api.emberjs.com/ember/6.5.0/classes/@ember%2Fapplication/methods/getOwner?anchor=getOwner) instead.
