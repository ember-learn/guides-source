...
[`normalize()`](https://api.emberjs.com/ember-data/3.18/classes/JSONAPISerializer/methods/normalizeResponse?anchor=normalize)
hook similarly.
...
the
[`keyForRelationship()`](https://api.emberjs.com/ember-data/3.18/classes/JSONAPISerializer/methods/keyForAttribute?anchor=keyForRelationship)
method.
...
[normalizeResponse](https://api.emberjs.com/ember-data/3.18/classes/Serializer/methods/serialize?anchor=normalizeResponse)
