...
Using the [`{{array}}`](https://api.emberjs.com/ember/3.19/classes/Ember.Templates.helpers/methods/array?anchor=array) helper,
...
To consult all available built-in helpers, you can check the [template helpers API documentation](https://api.emberjs.com/ember/3.19/classes/Ember.Templates.helpers/).
