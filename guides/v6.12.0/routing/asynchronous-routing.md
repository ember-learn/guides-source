...
resolved. The values passed to the [`setupController()`](https://api.emberjs.com/ember/6.12.0/classes/Route/methods/setupController?anchor=setupController) hook for each route
