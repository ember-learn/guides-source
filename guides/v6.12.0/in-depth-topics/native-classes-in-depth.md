...
Ember provides [a number of decorators](https://api.emberjs.com/ember/6.12.0/modules/@ember%2Fobject#functions), such as the [`@tracked` decorator](https://api.emberjs.com/ember/6.12.0/functions/@glimmer%2Ftracking/tracked), that
