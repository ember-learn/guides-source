...
To define a new Ember _class_, call the [`extend()`](https://api.emberjs.com/ember/3.10/classes/@ember%2Fobject/methods/extend?anchor=extend) method on
[`EmberObject`](https://api.emberjs.com/ember/3.10/modules/@ember%2Fobject):
...
of Ember's built-in [`Component`](https://api.emberjs.com/ember/3.10/classes/Component) class:
...
class by calling its [`create()`](https://api.emberjs.com/ember/3.10/classes/@ember%2Fobject/methods/create?anchor=create) method. Any methods, properties and
...
When a new instance is created, its [`init()`](https://api.emberjs.com/ember/3.10/classes/EmberObject/methods/init?anchor=init) method is invoked automatically. This is the ideal place to implement setup required on new instances:
