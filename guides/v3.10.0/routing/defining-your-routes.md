...
The [`map()`](https://api.emberjs.com/ember/3.10/classes/EmberRouter/methods/map?anchor=map) method
...
for [the router](https://api.emberjs.com/ember/3.10/classes/EmberRouter) and for [route
handlers](https://api.emberjs.com/ember/3.10/classes/Route).
