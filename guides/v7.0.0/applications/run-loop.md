...
The run loop API calls that _schedule_ work, i.e. [`run.schedule`](https://api.emberjs.com/ember/7.0.0/classes/@ember%2Frunloop/methods/schedule?anchor=schedule),
[`run.scheduleOnce`](https://api.emberjs.com/ember/7.0.0/classes/@ember%2Frunloop/methods/scheduleOnce?anchor=scheduleOnce),
[`run.once`](https://api.emberjs.com/ember/7.0.0/classes/@ember%2Frunloop/methods/once?anchor=once) have the property that they will approximate a run loop for you if one does not already exist.
...
Check out the [`@ember/runloop`](https://api.emberjs.com/ember/7.0.0/classes/@ember%2Frunloop) API documentation,
