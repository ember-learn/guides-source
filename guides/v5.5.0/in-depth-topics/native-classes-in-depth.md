...
Ember provides [a number of decorators](https://api.emberjs.com/ember/5.5.0/modules/@ember%2Fobject#functions), such as the [`@tracked` decorator](https://api.emberjs.com/ember/5.5.0/functions/@glimmer%2Ftracking/tracked), that
...
Instances can also make use of injection if they are embedded into the application container. To achieve this, you need to call [`setOwner`](https://api.emberjs.com/ember/5.5.0/functions/@ember%2Fapplication/setOwner) on the instance and supply the container. You can access the container by calling [`getOwner`](https://api.emberjs.com/ember/5.5.0/functions/@ember%2Fapplication/getOwner) on any framework object (components, services, routes, etc.).
