...
To do this, import the [`service` decorator](https://api.emberjs.com/ember/5.5.0/functions/@ember%2Fservice/service) and inject a `store` property into your class. Let's see an example using a route:
