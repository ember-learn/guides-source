...
To define a new Ember _class_, call the [`extend()`](https://api.emberjs.com/ember/3.3/classes/@ember%2Fobject/methods/extend?anchor=extend) method on
[`EmberObject`](https://api.emberjs.com/ember/3.3/modules/@ember%2Fobject):
...
of Ember's built-in [`Component`](https://api.emberjs.com/ember/3.3/classes/Component) class:
...
One common example is when overriding the [`normalizeResponse()`](https://api.emberjs.com/ember-data/3.3/classes/DS.JSONAPISerializer/methods/normalizeResponse?anchor=normalizeResponse) hook in one of Ember-Data's serializers.
...
class by calling its [`create()`](https://api.emberjs.com/ember/3.3/classes/@ember%2Fobject/methods/create?anchor=create
...
When a new instance is created, its [`init()`](https://api.emberjs.com/ember/3.3/classes/EmberObject/methods/init?anchor=init) method is invoked
