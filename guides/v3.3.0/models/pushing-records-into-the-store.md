...
To push a record into the store, call the store's [`push()`](https://api.emberjs.com/ember-data/release/classes/DS.Store/methods/push?anchor=push) method.
...
[`store.pushPayload()`](https://api.emberjs.com/ember-data/release/classes/DS.Store/methods/push?anchor=pushPayload) method.
