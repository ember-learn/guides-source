...
set the [`positionalParams`](https://api.emberjs.com/ember/3.3/classes/Component/properties/positionalParams?anchor=positionalParams) attribute in your component class.
