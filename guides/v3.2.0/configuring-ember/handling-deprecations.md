...
can use the [deprecation handlers](https://api.emberjs.com/ember/2.15/classes/Ember.Debug/methods/registerDeprecationHandler?anchor=registerDeprecationHandler) API to check for what
