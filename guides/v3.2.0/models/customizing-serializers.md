...
[`JSONAPISerializer`](https://api.emberjs.com/ember-data/3.2/classes/DS.JSONAPISerializer)
is the default serializer and works with JSON API backends. The
[`JSONSerializer`](https://api.emberjs.com/ember-data/3.2/classes/DS.JSONSerializer)
is a simple serializer for working with single JSON object or arrays of records. The
[`RESTSerializer`](https://api.emberjs.com/ember-data/3.2/classes/DS.RESTSerializer)
...
the [`serialize()`](https://api.emberjs.com/ember-data/3.2/classes/DS.JSONAPISerializer/methods/serialize?anchor=serialize)
...
API documentation](https://api.emberjs.com/ember-data/3.2/classes/DS.JSONAPISerializer).
...
[`keyForAttribute()`](https://api.emberjs.com/ember-data/3.2/classes/DS.JSONAPISerializer/methods/keyForAttribute?anchor=keyForAttribute)
...
[API docs](https://api.emberjs.com/ember-data/3.2/classes/DS.JSONSerializer)
...
[normalizeResponse](https://api.emberjs.com/ember-data/3.2/classes/DS.Serializer/methods/normalizeResponse?anchor=normalizeResponse)
...
[serialize](https://api.emberjs.com/ember-data/3.2/classes/DS.Serializer/methods/serialize?anchor=serialize)
method.
