...
```javascript {data-filename=app/routes/secret-articles.js}
export default Ember.Route.extend({
  beforeModel() {
...
[See the API Docs for `beforeModel`](https://api.emberjs.com/classes/Ember.Route.html#method_beforeModel)
...
[See the API Docs for `afterModel`](https://api.emberjs.com/classes/Ember.Route.html#method_afterModel)
