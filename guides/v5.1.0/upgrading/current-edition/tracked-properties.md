...
need to use the [`dependentKeyCompat`](https://api.emberjs.com/ember/5.1.0/functions/@ember%2Fobject%2Fcompat/dependentKeyCompat) decorator. This allows you to refactor
