...
When you pass an object as second argument into the `link-to` block helper, it will by default [serialize](https://api.emberjs.com/ember/3.13/classes/Route/methods/serialize?anchor=serialize) the object to the ID of the model into the URL.
