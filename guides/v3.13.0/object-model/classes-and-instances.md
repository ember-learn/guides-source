...
To define a new Ember _class_, call the [`extend()`](https://api.emberjs.com/ember/3.13/classes/@ember%2Fobject/methods/extend?anchor=extend) method on
[`EmberObject`](https://api.emberjs.com/ember/3.13/modules/@ember%2Fobject):
...
of Ember's built-in [`Component`](https://api.emberjs.com/ember/3.13/classes/Component) class:
...
One common example is when overriding the [`normalizeResponse()`](https://api.emberjs.com/ember-data/3.13/classes/JSONAPISerializer/methods/normalizeResponse?anchor=normalizeResponse) hook in one of Ember-Data's serializers.
...
class by calling its [`create()`](https://api.emberjs.com/ember/3.13/classes/@ember%2Fobject/methods/create?anchor=create) method. Any methods, properties and
...
When a new instance is created, its [`init()`](https://api.emberjs.com/ember/3.13/classes/EmberObject/methods/init?anchor=init) method is invoked automatically. This is the ideal place to implement setup required on new instances:
...
[Ember proxy objects](https://api.emberjs.com/ember/3.13/classes/ObjectProxy) are the one big exception to this rule. If you're working with Ember proxy objects, including promise proxies for async relationships in Ember Data, you have to use Ember's [`get()`](https://api.emberjs.com/ember/3.13/classes/@ember%2Fobject/methods/get?anchor=get) accessor method to read values.
