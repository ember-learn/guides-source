Statements like [`if`](https://api.emberjs.com/ember/3.13/classes/Ember.Templates.helpers/methods/if?anchor=if)
...
[`{{if}}`](https://api.emberjs.com/ember/3.13/classes/Ember.Templates.helpers/methods/if?anchor=if)
