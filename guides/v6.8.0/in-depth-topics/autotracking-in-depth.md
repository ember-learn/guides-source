...
be tracked. In this case, you can use `trackedObject` from [@ember/reactive/collections](https://api.emberjs.com/ember/6.8.0/modules/@ember%2Freactive%2Fcollections):
...
When you want to track the contents of an Array, you can use `trackedArray` from [@ember/reactive/collections](https://api.emberjs.com/ember/6.8.0/modules/@ember%2Freactive%2Fcollections):
