...
you can use the [`{{#each-in}}`](https://api.emberjs.com/classes/Ember.Templates.helpers.html#method_each-in) helper:
...
and use the [`{{#each}}`](https://api.emberjs.com/classes/Ember.Templates.helpers.html#method_each-in) helper instead.
