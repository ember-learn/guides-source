...
For a full list of built-in Helpers, see the [Ember.Templates.helpers](https://api.emberjs.com/ember/3.9/classes/Ember.Templates.helpers/)
API documentation.

### Using a helper to get a property dynamically

The [`{{get}}`](https://api.emberjs.com/ember/3.9/classes/Ember.Templates.helpers/methods/get?anchor=get) helper
...
For example, the [`{{concat}}`](https://api.emberjs.com/ember/3.9/classes/Ember.Templates.helpers/methods/concat?anchor=concat)
...
The [`{{let}}`](https://api.emberjs.com/ember/3.9/classes/Ember.Templates.helpers/methods/let?anchor=let) helper lets you create new bindings in your template.
...
Using the [`{{array}}`](https://api.emberjs.com/ember/3.9/classes/Ember.Templates.helpers/methods/array?anchor=array) helper,
