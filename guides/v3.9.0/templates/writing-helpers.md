...
[`htmlSafe`](https://api.emberjs.com/ember/3.9/functions/@ember%2Ftemplate/htmlSafe) string utility:
...
to [`htmlSafe`](https://api.emberjs.com/ember/3.9/functions/@ember%2Ftemplate/htmlSafe)), Ember knows that you have vouched on its behalf that it
