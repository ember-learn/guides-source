...
[`createRecord()`](https://api.emberjs.com/ember/2.18/classes/DS.Store/methods/createRecord?anchor=createRecord)
method on the store.
...
Call [`save()`](https://api.emberjs.com/ember/2.18/classes/DS.Model/methods/save?anchor=save)
...
[`hasDirtyAttributes`](https://api.emberjs.com/ember/2.18/classes/DS.Model/properties/hasDirtyAttributes?anchor=hasDirtyAttributes)
property. You can also see what parts of
the record were changed and what the original value was using the
[`changedAttributes()`](https://api.emberjs.com/ember/2.18/classes/DS.Model/methods/changedAttributes?anchor=changedAttributes)
...
[`rollbackAttributes()`](https://api.emberjs.com/ember/2.18/classes/DS.Model/methods/rollbackAttributes?anchor=rollbackAttributes)
...
[`save()`](https://api.emberjs.com/ember/2.18/classes/DS.Model/methods/save?anchor=save) returns
...
Deleting records is as straightforward as creating records. Call [`deleteRecord()`](https://api.emberjs.com/ember/2.18/classes/DS.Model/methods/deleteRecord?anchor=deleteRecord)
...
the [`destroyRecord`](https://api.emberjs.com/ember/2.18/classes/DS.Model/methods/deleteRecord?anchor=destroyRecord) method to delete and persist at the same time.
...
[findRecord]: <https://api.emberjs.com/ember/2.18/classes/DS.Store/methods/findRecord?anchor=findRecord>
