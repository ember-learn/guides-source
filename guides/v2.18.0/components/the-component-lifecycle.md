...
[did-insert-element]: https://api.emberjs.com/ember/2.18/classes/Component/events/didInsertElement?anchor=didInsertElement
[dollar]: https://api.emberjs.com/ember/2.18/classes/Component/methods/$?anchor=%24
...
When a component detects that it is time to remove itself from the DOM, Ember will trigger the [`willDestroyElement()`](https://api.emberjs.com/ember/2.18/classes/Component/events/willDestroyElement?anchor=willDestroyElement) method,
