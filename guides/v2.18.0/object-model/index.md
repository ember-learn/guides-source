...
[Ember.Object](https://api.emberjs.com/ember/2.18/modules/@ember%2Fobject) also provides a class system, supporting features like mixins
...
localization methods](https://api.emberjs.com/ember/2.18/classes/String).
