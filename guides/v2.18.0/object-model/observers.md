...
To get around these problems, you should make use of [`Ember.run.once()`](https://api.emberjs.com/ember/2.18/classes/@ember%2Frunloop/methods/once?anchor=once).
...
using [`addObserver()`](https://api.emberjs.com/ember/2.18/classes/@ember%2Fobject%2Fobservers/methods/addObserver?anchor=addObserver):
