...
The [`{{get}}`](https://api.emberjs.com/ember/2.18/classes/Ember.Templates.helpers/methods/get?anchor=get) helper makes it easy to dynamically send the value of a
...
For example, the [`{{concat}}`](https://api.emberjs.com/ember/2.18/classes/Ember.Templates.helpers/methods/get?anchor=concat) helper makes it easy to dynamically send
