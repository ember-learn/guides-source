...
2. The component's element is accessible via the component's
   [`$()`](https://api.emberjs.com/ember/release/classes/Component/methods/$?anchor=%24)
   method.

A component's [`$()`](https://api.emberjs.com/ember/release/classes/Component/methods/$?anchor=%24) method allows you to access the component's DOM element by returning a jQuery element.
...
[`$()`](https://api.emberjs.com/ember/release/classes/Component/methods/$?anchor=%24) will, by default, return a jQuery object for the component's root element, but you can also target child elements within the component's template by passing a selector:
