...
you can yield the component using the [`component helper`](https://api.emberjs.com/ember/3.1/classes/Ember.Templates.helpers/methods/component?anchor=component) and [`hash helper`](https://api.emberjs.com/ember/3.1/classes/Ember.Templates.helpers/methods/hash?anchor=hash).
