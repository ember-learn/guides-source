...
- [DS.Adapter](https://api.emberjs.com/ember-data/3.1/classes/DS.Adapter) is the basic adapter
...
- [DS.JSONAPIAdapter](https://api.emberjs.com/ember-data/3.1/classes/DS.JSONAPIAdapter)
...
- [DS.RESTAdapter](https://api.emberjs.com/ember-data/3.1/classes/DS.RESTAdapter)
